...
void MainWindow::RenderImgui()
{
	...
	//imgui 
	{
		...
		ImGui::Separator();
		glm::vec4 colors[6];
		colors[0] = glm::vec4(255, 0, 0, 255);
		colors[1] = glm::vec4(0, 255, 0, 255);
		colors[2] = glm::vec4(0, 0, 255, 255);
		colors[3] = glm::vec4(0, 255, 255, 255);
		colors[4] = glm::vec4(255, 0, 255, 255);
		colors[5] = glm::vec4(255, 255, 0, 255);
		std::string desc[6];
		desc[0] = "T";
		desc[1] = "R";
		desc[2] = "S";
...
void MainWindow::RenderScene()
{
	...
	// Displacements
	float horiz[6] = { -0.5, 0, 0.5,  -0.5,  0, 0.5 };
	float vert[6] = { 0, 0, 0, -0.5, -0.5, -0.5 };
   ...
   for (int i = 0; i <= 5; ++i)
	{
		...
		m_mainShader->setMat4("m", final);
		m_mainShader->setVec4("uColor", colors[i]);
