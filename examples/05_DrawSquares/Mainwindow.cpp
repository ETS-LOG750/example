...
void MainWindow::RenderScene()
{
	...
	// Draw the first square (separate vertices)
	{
		...
		m_mainShader->setMat4("mvMatrix", MvMatrix);

		// red
		m_mainShader->setVec4("uColor", glm::vec4(1.0, 0.0, 0.0, 1.0));
	...
	// Draw the second square (shared vertices)
	{
		...
		// blue
		m_mainShader->setVec4("uColor", glm::vec4(0.0, 0.0, 1.0, 1.0)); // rgba
	...
	// Draw the third square (triangle fan)
	{
		...
		// green
		m_mainShader->setVec4("uColor", glm::vec4(0.0, 1.0, 0.0, 1.0)); // rgba
